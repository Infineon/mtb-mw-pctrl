/**
 * @file    mppt_port.h
 * @brief   Port configuration for MPPT Perturb and Observe block
 *
 */
...
#ifndef MPPT_PORT_H__
#define MPPT_PORT_H__
...
#define PCTRL_FABSF(x)        (((x) < 0.0F) ? -(x) : (x))

#ifdef __cplusplus
} /* Extern C */
#endif

#endif // ifndef MPPT_PORT_H__
